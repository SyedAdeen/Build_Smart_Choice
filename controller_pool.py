...
class SignupController:
    ...
    def signup(self,poolname,poolsize):
        ...
        try:
            ...
            self.signup_model.create_user(username, hashed_password, emailaddr, secret,poolname,poolsize)
...
class VerifyUserController:
    ...
    def verify_user(self,poolname,poolsize):
        ...
        try:
            ...
            user = self.verify_user_model.verify_user(username, secret,poolname,poolsize)
...
class CheckPassController2:
    ...
    def check_pass2(self,poolname,poolsize):
        ...
        try:
            ...
            user = self.check_pass_model.update_secret(username, new_secret, password,poolname,poolsize)
