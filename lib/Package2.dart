...
class Pack2 extends StatefulWidget {
  String user;
  Pack2({super.key, required this.user});

  @override
  State<Pack2> createState() => _Pack2State();
}

class _Pack2State extends State<Pack2> {
  @override
...
// ignore: must_be_immutable
class Package2Page extends StatefulWidget {
  String user;
  Package2Page({super.key, required this.user});

  @override
  State<Package2Page> createState() => _Package2PageState();
}

class _Package2PageState extends State<Package2Page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
