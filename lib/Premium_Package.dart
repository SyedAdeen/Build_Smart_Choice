...
class PremiumPack extends StatefulWidget {
  ...
  @override
  State<PremiumPack> createState() => _Pack1State();
}

class _Pack1State extends State<PremiumPack> {
...
//   PremiumPack({Key? key, required this.user, required this.selectedImages})
//       : super(key: key);
