...
class BasementSingle extends StatefulWidget {
  ...
  _BasementSingleState createState() => _BasementSingleState();
}
  ...
  Future<void> fetchImagesData() async {
    try {
      if (widget.area == 1.toString()) {
        ...
        final response = await http.get(
            Uri.parse('${ApiUrls.baseUrl}/get_imagesb1?table_name=layout_20'));
        ...
        final response = await http
            .get(Uri.parse(
                '${ApiUrls.baseUrl}/get_imagesb1?table_name=layout_${widget.area}'))
    ...
    try {
      if (widget.area == 1.toString()) {
        ...
        final response2 = await http.get(Uri.parse(
            '${ApiUrls.laboursinglestorybasementpackage}?area=10 MARLA&set=$id'));
        ...
        final response2 = await http.get(Uri.parse(
            '${ApiUrls.laboursinglestorybasementpackage}?area=20 MARLA&set=$id'));
        ...
        final response2 = await http.get(Uri.parse(
            '${ApiUrls.laboursinglestorybasementpackage}?area=${widget.area} MARLA&set=$id'));
              ...
              : Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final basements = imageData['basement'];
